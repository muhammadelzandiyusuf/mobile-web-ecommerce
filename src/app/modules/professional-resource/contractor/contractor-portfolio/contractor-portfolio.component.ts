...
export class ContractorPortfolioComponent implements OnInit {
  ...
  constructor(
    private comtractorService: ContractorService,
  ...
  getPortfolioDetail(url: any) {
    this.comtractorService.getContractorPortfolioDetail(url)
  ...
  onLoad() {
    ...
    if(isMobile){
      for (let object of this.portfolioProduct) {
        this.pinTag.push(
          {
            'contractor_portfolio_image_id': object.contractor_portfolio_image_id,
